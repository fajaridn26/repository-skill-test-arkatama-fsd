                    ...
                    <div>
                        ...
                        <div>
                            ...
                            @if (session()->has('loginError'))
                                <x-ui.alert variant="error" title="Gagal" :message="session('loginError')" :showLink="false" />
                            @elseif (session()->has('registerSuccess'))
                                <x-ui.alert variant="success" title="Berhasil" :message="session('registerSuccess')" :showLink="false" />
                            @elseif (session()->has('successReset'))
                                <x-ui.alert variant="success" title="Berhasil" :message="session('successReset')" :showLink="false" />
                            @endif
