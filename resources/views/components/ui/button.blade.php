...
@php
    ...
    $variantMap = [
        ...
        'outline-success' =>
            'bg-white text-green-500 ring-1 ring-inset ring-green-300 hover:bg-green-50 dark:bg-green-800 dark:text-green-400 dark:ring-green-700 dark:hover:bg-white/[0.03] dark:hover:text-green-300',
        'outline-danger' =>
            'bg-white text-red-500 ring-1 ring-inset ring-red-300 hover:bg-red-50 dark:bg-red-800 dark:text-red-400 dark:ring-red-700 dark:hover:bg-white/[0.03] dark:hover:text-red-300',
    ];
